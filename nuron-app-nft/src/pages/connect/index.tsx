...
const ConnectPage: FC = () => {
  ...
  const login = async () => {
    if (!isAuthenticated) {
      try {
        await authenticate({ signingMessage: 'Log in artcc nft' });
      } catch (e) {
        console.error(e);
      }
    }
          ...
          <div className="row g mb--50 mb_md--30 mb_sm--30 align-items-center">
            <div className="col-lg-6" data-sal="slide-up" data-sal-delay={150} data-sal-duration={800}>
              ...
              <p className="connect-td">
                Connect with one of available wallet providers or create a new wallet. <a href="#">What is a wallet?</a>
              </p>
            </div>
                  ...
                  <div className="wallet-wrapper">
                    <div className="inner">
                      ...
                      <div className="content">
                        ...
                        <p className="description">A crypto wallet & gateway to blockchain apps</p>
                      </div>
                    </div>
